...
def main():
    ...
    user_inputs.update({
        ...
        'PRGNAN10': st.sidebar.selectbox("Pregnancy History", [0, 1]),
        'MIGRAIN10': st.sidebar.selectbox("Migraine", [0, 1]),
        'OSTEOPO10': st.sidebar.selectbox("Osteoporosis", [0, 1]),
        'THYROI110': st.sidebar.selectbox("Thyroid Disorder", [0, 1]),
        'NERVS110': st.sidebar.selectbox("Nerve Problems", [0, 1]),
        'ARTHRT110': st.sidebar.selectbox("Arthritis", [0, 1]),
        'SMOKERE10': st.sidebar.selectbox("Smoking Status", [0, 1]),
        'HLTHSER10': st.sidebar.selectbox("Health Service Utilization", [0, 1]),
        'INSURAN10': st.sidebar.selectbox("Health Insurance", [0, 1]),
        'MDTALK10': st.sidebar.selectbox("Discussed Health with Doctor", [0, 1]),
        'YOGA10': st.sidebar.selectbox("Practices Yoga", [0, 1]),
        'DIETNUT10': st.sidebar.selectbox("Follows a Nutritious Diet", [0, 1])
    })
    ...
    if st.sidebar.button("Predict"):
        ...
        cluster_info = {
            0: "🚨 **High-Risk Profile**: Significant health risks, including chronic conditions and mental health concerns. Medical intervention is advised.",
            1: "⚠️ **Moderate-Risk Profile**: Manageable health conditions. Regular check-ups and a healthy lifestyle are recommended.",
            2: "✅ **Low-Risk Profile**: Good overall health. Maintaining healthy habits is encouraged."
        }
